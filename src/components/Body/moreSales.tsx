...
export default function () {
    ...
    if (process.browser) {
      const Images = document.querySelectorAll('.bg-dark')
      useEffect(() => {
    ...
    return(
        ...
        <a href="#"><Image className='w-50 h-50 text-center' src={RedShoe} alt='ShoeShooter'/></a>
        <p className='fs-5 fw-bold text-light'>R$80,75</p>
        </div>
        <div className='m-1 bg-dark  h-25 mb-5'>
        <h3 className='text-light'>Tuks</h3>
        <a href="#"><Image className='w-50 h-50 text-center' src={Tuks} alt='ShoeShooter'/></a>
        <p className='fs-5 fw-bold text-light'>R$100,00</p>
        </div>
        <div className='m-1 bg-dark  h-25 mb-5'>
        <h3 className='text-light'>WhiteShoe</h3>
        <a href="#"><Image className='w-50 h-50 text-center' src={WhiteShoe} alt='ShoeShooter'/></a>
        <p className='fs-5 fw-bold text-light'>R$25,99</p>
        </div>
        <div className='m-1 bg-dark  h-25 mb-5'>
        <h3 className='text-light'>Numberr</h3>
        <a href="#"><Image className='w-50 h-50 text-center' src={ShoesWhite} alt='ShoeShooter'/></a>
      ...
      <a href="#"><Image className='w-50 h-50 text-center w-75 h-25 mb-5 pb-5' src={RedShoe} alt='ShoeShooter'/></a>
        <Carousel.Caption>
        <h3 className='text-light'>RedShoe</h3>
        <p className='fs-5 fw-bold text-light'>R$80,75</p>
        </Carousel.Caption>
      ...
      <Carousel.Item className="text-center">
      <a href="#"><Image className='w-50 h-50 text-center w-75 h-25 mb-5 pb-5' src={Tuks} alt='ShoeShooter'/></a>
        <Carousel.Caption>
        <h3 className='text-light'>Tuks</h3>
        <p className='fs-5 fw-bold text-light'>R$100,00</p>
        </Carousel.Caption>
      ...
      <Carousel.Item className="text-center">
      <a href="#"><Image className='w-50 h-50 text-center w-75 h-25 mb-5 pb-5' src={WhiteShoe} alt='ShoeShooter'/></a>
        <Carousel.Caption>
        <h3 className='text-light'>WhiteShoe</h3>
        <p className='fs-5 fw-bold text-light'>R$25,99</p>
        </Carousel.Caption>
      ...
      <Carousel.Item className="text-center">
      <a href="#"><Image className='w-50 h-50 text-center w-75 h-25 mb-5 pb-5' src={ShoesWhite} alt='ShoeShooter'/></a>
        <Carousel.Caption>
        <h3 className='text-light'>Numberr</h3>
        <p className='fs-5 fw-bold text-light'>R$120,10</p>
        </Carousel.Caption>
