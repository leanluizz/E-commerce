...
function ControlledCarousel() {
  ...
  return (
    ...
    <h3 className='text-danger text-opacity-75 mt-5'>Venda com 50% de desconto</h3>  
      <div className='d-flex justify-content-center'>
      <Button className='btn-danger bg-gradient m-5'>Saiba mais</Button>
      <Button className='btn-danger bg-gradient m-5'>Ofertas</Button>
      </div>
      ...
      <div className='m-1 bg-dark w-25 h-25 mb-5'>
        ...
        <a href="#"><Image className='w-75 h-75 text-center' src={Tuks} alt='Tuks'/></a>
        <p className='fs-5 fw-bold text-light'>R$100,00</p>
        </div>
        <div className='m-1 bg-dark w-25 h-25 mb-5'>
        <h3 className='text-light'>ShoeMan</h3>
        <a href="#"><Image className='w-75 h-75 text-center' src={ShoeMan} alt='ShoeMan'/></a>
        <p className='fs-5 fw-bold text-light'>R$230,34</p>
        </div>
        <div className='m-1 bg-dark w-25 h-25 mb-5'>
        <h3 className='text-light'>ShoeShooter</h3>
        <a href="#"><Image className='w-75 h-75 text-center' src={ShoeShooter} alt='ShoeShooter'/></a>
        <p className='fs-5 fw-bold text-light'>R$500,10</p>
        </div>
        <div className='m-1 bg-dark w-25 h-25 mb-5'>
        <h3 className='text-light'>Cutters</h3>
        <a href="#"><Image className='w-75 h-75 text-center' src={Cutters} alt='Cutters'/></a>
    ...
    <Carousel className='d-lg-none m-5' activeIndex={index} onSelect={handleSelect}>
      ...
      <a href="#"><Image className='w-75 h-25 mb-5 pb-5 text-center' src={ShoeMan} alt='ShoeMan'/></a>
        <Carousel.Caption>
          <h3>ShoeMan</h3>
      ...
      <Carousel.Item className='text-center'>
      <a href="#"><Image className='w-75 h-25 mb-5 pb-5 text-center' src={ShoeShooter} alt='ShoeShooter'/></a>
        <Carousel.Caption>
          <h3>ShoeShooter</h3>
      ...
      <Carousel.Item className='text-center'>
      <a href="#"><Image className='w-75 h-25 mb-5 pb-5 text-center' src={Cutters} alt='Cutters'/></a>
        <Carousel.Caption>
          <h3>Cutters</h3>
