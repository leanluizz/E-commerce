...
<div className={DropdownCSS.dropdown}>
  ...
  <div className={DropdownCSS.dropdowncontent}>
    <a className='bg-danger bg-gradient rounded-top' href="#">Masculino</a>
    <a className='bg-danger bg-gradient' href="#">Feminino</a>
    <a className='bg-danger bg-gradient rounded-bottom' href="#">Infantil</a>
  </div>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-card-list" viewBox="0 0 16 16">
  ...
  <div className={DropdownCSS.dropdowncontent}>
    ...
    <a className='bg-danger bg-gradient' href="#">Reembolso</a>
    <a className='bg-danger bg-gradient rounded-bottom' href="#">Endereço</a>
  </div>
</div>
    </>
