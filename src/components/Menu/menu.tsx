    ...
    return(
        <div className=' w-100 d-flex justify-content-between align-items-center'>
           ...
           <Link href='/'><Image width={100} loading="eager" priority={true} className={ MenuCSS.icon } src={ShoeIcon} alt='iconMenu'/></Link>
            ...
            <Link className=" link-offset-2 link-underline link-underline-opacity-0 text-danger" href="">Ajuda</Link>
             <Link className=" link-offset-2 link-underline link-underline-opacity-0 ms-5 text-danger" href="">
                Trabalhe conosco
             </Link>
            </div>
        </div>
