...
export default function list(){
    ...
    return(
        <ul className='p-0'>
            ...
            <Accordion.Body className='bg-danger bg-gradient'>     
            <li><a className='text-light bg-transparent text-center rounded-top' href="#">Masculinos</a></li>
            <li><a className='text-light bg-transparent text-center' href="#">Femininos</a></li>
            <li><a className='text-light bg-transparent text-center' href="#">Infantil</a></li>
             </Accordion.Body>
            </Accordion.Item>
            </Accordion>
            </li>
            ...
            <li><a className='text-light bg-transparent text-center' href="#">Reembolso</a></li>
            <li><a className='text-light bg-transparent text-center' href="#">Endereço</a></li>
             </Accordion.Body>
            </Accordion.Item>
            </Accordion>
            </li>
