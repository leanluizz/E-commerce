...
export default function Success(){
  ...
  <div>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" className="m-5 bi bi-check-circle-fill" viewBox="0 0 16 16">
      ...
      <h1 id={SucessCSS.title} className='ps-5 pe-5 text-light text-center'>Welcome to ShoesShooting!</h1>
      <h2 id={SucessCSS.pg} className='text-center text-light p-5'>Your has registered!</h2>
      <div className='w-50 d-flex justify-content-between'>
      <Link href='/' id={SucessCSS.link} className='text-dark fw-bolder'>Back to store</Link>
